  ...
  return (
    <div className="py-10 px-5 sm:px-10 max-w-6xl mx-auto space-y-16">
      ...
      <section className="text-center">
        ...
        />
        <Title text1={'ABOUT '} text2={'SWEATMODE'}/>
      ...
      {/* Achievements & Badges */}
      <section className="text-center">
        <h2 className="text-xl font-semibold mb-8 text-gray-800">Achievements & Highlights</h2>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="bg-white shadow-md p-6 rounded-xl flex flex-col items-center">
            ...
            <h4 className="text-lg font-semibold text-gray-700">Top Startup 2024</h4>
          ...
          <div className="bg-white shadow-md p-6 rounded-xl flex flex-col items-center">
            ...
            <h4 className="text-lg font-semibold text-gray-700">15,000+ Customers</h4>
          ...
          <div className="bg-white shadow-md p-6 rounded-xl flex flex-col items-center">
            ...
            <h4 className="text-lg font-semibold text-gray-700">100% Growth</h4>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          <h2 className="text-xl font-semibold mb-4 text-gray-800">Why SweatMode?</h2>
